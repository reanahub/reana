...
## [0.95.0](https://github.com/reanahub/reana/compare/0.9.4...0.95.0) (2026-08-20)
...
* **helm:** add k8s resource request/limits for infra components ([#889](https://github.com/reanahub/reana/issues/889)) ([865bd99](https://github.com/reanahub/reana/commit/865bd998547755f1e3e97133639917f30c8ac99f))
...
* **helm:** enrich disabled local development configuration ([#983](https://github.com/reanahub/reana/issues/983)) ([798a5ca](https://github.com/reanahub/reana/commit/798a5caba211fe68052ac280c37c251295721d22))
...
* **helm:** support fsGroup-based shared storage access ([#984](https://github.com/reanahub/reana/issues/984)) ([df18220](https://github.com/reanahub/reana/commit/df182201cc578db8773e5cb2a8f7733278dbd9bb))
...
* **helm:** support sandboxed workflow specification validation ([#980](https://github.com/reanahub/reana/issues/980)) ([7042200](https://github.com/reanahub/reana/commit/7042200d5381d09d5672d0a837edbb97362adc1e))
* **helm:** support separate runtime namespace for workflow pods ([#955](https://github.com/reanahub/reana/issues/955)) ([2d46c83](https://github.com/reanahub/reana/commit/2d46c83922b289f313ec7b9e8ab600551a60d9db)), closes [#954](https://github.com/reanahub/reana/issues/954)
...
* **scripts:** add local CERN CoreDNS helper ([#989](https://github.com/reanahub/reana/issues/989)) ([6e700b4](https://github.com/reanahub/reana/commit/6e700b4a299e7052ced6852938b374d8a193f80b))
...
* **helm:** add quota management secret default ([#982](https://github.com/reanahub/reana/issues/982)) ([50d6cd2](https://github.com/reanahub/reana/commit/50d6cd2bdaac4550841917c673f7c26c699d7e77))
...
* **helm:** update Traefik chart repository ([#992](https://github.com/reanahub/reana/issues/992)) ([c275bf2](https://github.com/reanahub/reana/commit/c275bf2c254865dc69d9fdaccc94ceb1d90efd8b)), closes [#991](https://github.com/reanahub/reana/issues/991)
...
* **reana-dev:** use current PR references in git-checkout-pr ([#988](https://github.com/reanahub/reana/issues/988)) ([e1d4a62](https://github.com/reanahub/reana/commit/e1d4a6246080b3f9c7bc4ed58413079c465da917)), closes [#987](https://github.com/reanahub/reana/issues/987)
...
* **helm:** document local HTCondor testing ([#989](https://github.com/reanahub/reana/issues/989)) ([5aab9fe](https://github.com/reanahub/reana/commit/5aab9fe70d699cf751defbee97a81a287696d387))
...
* **helm:** improve Slurm compute backend documentation ([#985](https://github.com/reanahub/reana/issues/985)) ([371ec22](https://github.com/reanahub/reana/commit/371ec2238a328e6d8743e2b71052d4f1b55bd137))
