...
for image in \
    ...
    docker.io/reanahub/reana-job-controller:0.95.0-alpha.4 \
    docker.io/reanahub/reana-message-broker:0.95.0-alpha.3 \
    docker.io/reanahub/reana-server:0.95.0-alpha.5 \
    docker.io/reanahub/reana-ui:0.95.0-alpha.3 \
    docker.io/reanahub/reana-workflow-controller:0.95.0-alpha.6 \
    docker.io/reanahub/reana-workflow-engine-cwl:0.95.0-alpha.4 \
