...
sed 's/name: multikueue-test-job/name: remote-test-job/g; s/queue-name: worker-queue/queue-name: local-queue-job/g' "$(dirname "$0")/../etc/sample-job.yaml" >remote-test-job.yaml
